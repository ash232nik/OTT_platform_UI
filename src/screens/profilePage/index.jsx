        ...
        <div className="detailsContainer">
          ...
          <div className="legalContainer">
            ...
            <DetailsCard className="legalBox">
              When we purchase large ticket items, such as a set of appliances,
              we generally enter into a contract with the store to deliver and
              install such appliances. These agreements are legally binding on
              both parties. Furthermore, if you have ever written a will, this
              is actually a legally binding agreement. Similarly, healthcare and
